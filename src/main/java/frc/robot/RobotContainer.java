...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    kSwerveSubsystem.setDefaultCommand(kSwerveSubsystem.driveFieldOriented
            (kDriverController.getLeftX(), kDriverController.getLeftY(), kDriverController.getLeftX(), true,
                    Constants.ControllerConstants.kCANOpenLoop));
  ;}
